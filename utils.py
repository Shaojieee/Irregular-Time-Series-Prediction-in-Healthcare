...
def parse_args():
    ...
    parser.add_argument(
        "--model_type", type=str, default='mtand_strats', help="mtand_strats, mtand, strats"
    )
    parser.add_argument(
...
def forecast_parse_args():
    ...
    parser.add_argument(
        "--model_type", type=str, default='mtand_strats', help="mtand_strats, mtand, grud, seft, strats"
    )
    parser.add_argument(
        "--len_time_query", type=int, default=48, help="len of time query vector in mtand"
    )
