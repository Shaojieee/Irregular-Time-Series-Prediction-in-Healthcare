...
raw_data_path = '/home/FYP/szhong005/fyp/physionet_2012'
...
# Store data.
os.makedirs('./data_physionet',exist_ok=True)
pickle.dump([ts, oc, train_ind, valid_ind, test_ind], open('./data_physionet/physionet_2012_preprocessed.pkl','wb'))
